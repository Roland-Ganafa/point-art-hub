...
const InvoiceManagement = () => {
  ...
  const generatePDF = (invoice: Invoice) => {
    ...
    // Open in new window for printing/saving as PDF using a safer approach
    // Note: The document.write usage here is safe as it's writing HTML content generated by our application
    // and not user-provided content, so it's not vulnerable to XSS.
    const printWindow = window.open('', '_blank');
    if (printWindow) {
      // Instead of using document.write, we'll set the document content directly
