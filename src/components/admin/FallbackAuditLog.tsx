      ...
      <CardContent>
        ...
        <div className="bg-yellow-50 dark:bg-yellow-950/30 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4 mb-6">
          ...
          <p className="text-yellow-700 mb-2">
            The <code className="bg-yellow-100 dark:bg-yellow-900/30 px-1.5 py-0.5 rounded">audit_log</code> table does not exist in your database.
          </p>
        ...
        <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
          <h3 className="font-medium text-gray-800 dark:text-gray-200 mb-3">Alternative Solutions:</h3>
          <ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm">
            <li className="flex gap-2">
              <span className="text-gray-400">•</span>
              <span>
                <strong>Run migrations:</strong> If you have a migrations folder, run{" "}
                <code className="bg-gray-200 dark:bg-gray-700 px-1.5 py-0.5 rounded text-xs">supabase db push</code>
              </span>
            </li>
            <li className="flex gap-2">
              <span className="text-gray-400">•</span>
